-- ============================================================
-- PATIENT PATH LITE — Complete Database Schema
...
CREATE TABLE public.staff_profiles (
  ...
  CONSTRAINT staff_profiles_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE
);
...
-- 5. GRANT EXECUTE on helper functions (THIS IS THE CRITICAL FIX)
...
-- 13. Storage bucket for lab result files
...
-- Now create a demo admin user via the app's sign-up form,
-- or use the Supabase Auth dashboard to create one.
-- ============================================================
